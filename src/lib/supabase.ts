...
export function getStoredSupabaseConfig(): SupabaseConfig {
  ...
  if (typeof window === 'undefined') {
    return {
      url: process.env.VITE_SUPABASE_URL || process.env.SUPABASE_URL || defaultUrl,
      anonKey: process.env.VITE_SUPABASE_ANON_KEY || process.env.SUPABASE_ANON_KEY || defaultKey,
      tableName: 'law_firms',
      isConnected: true,
    };
  }
